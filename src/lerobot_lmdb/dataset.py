    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("LmdbFrameDataset requires PyTorch. Install `lerobot-lmdb[examples]`.") from exc
            ...
            for key in self.video_keys:
                ...
                if not path.exists():
                    raise FileNotFoundError(
                        f"Missing cache {path}. Build it with `lerobot-lmdb-build {self.dataset_root}`."
                    )
